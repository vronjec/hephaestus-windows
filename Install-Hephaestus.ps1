...
Workflow Install-Hephaestus
{
    ...
    Parallel {
        ...
        Sequence {
            ...
            Start-Process -FilePath "$env:temp\ChromeSetup" -ArgumentList "/install /silent" -Wait
            ...
            Start-Process -FilePath "$env:temp\FirefoxSetup" -ArgumentList "-ms" -Wait

            # Install latest Opera
            Invoke-WebRequest "https://net.geo.opera.com/opera/stable/windows" -OutFile "$env:temp\OperaSetup.exe"
            Start-Process -FilePath "$env:temp\OperaSetup" -ArgumentList "/silent /launchopera 0" -Wait
            ...
            Start-Process -FilePath "$env:temp\LastPassSetup" -ArgumentList "--silinstall --userinstallff --userinstallie --noaddremove --nostartmenu --nohistory" -Wait
        } # Sequence
